...
import {defaultGroup} from "../common/config/config";
...
export class WebsocketService {
     ...
     * @param userId 
     */
    async updateSocketMes(socketId: string,clientIp: string,userId: string|string[]) {
     ...
     * @param userId  
     */
    async userOffline(userSocketId: string, userId: string) {
